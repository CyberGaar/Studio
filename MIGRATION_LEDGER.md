...
| P11 Security platform | `migration/0.2-security-bootstrap` | | N/A | Phase 0 validation and actionlint passed | Gitleaks: zero findings; 23 action references pinned | | | Ready for review |
...
| 0.2 Security and CI bootstrap | `migration/0.2-security-bootstrap` | | N/A | Phase 0 validation and actionlint passed | Gitleaks: zero findings; 23 action references pinned | | | Ready for review |
