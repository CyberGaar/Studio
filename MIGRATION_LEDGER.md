...
| 0.4 pnpm supply-chain policy | `migration/0.4-pnpm-supply-chain` | | Passed | Shared frozen workspace lock, strict build allowlist, and prior database validation passed | pnpm audit, OSV-Scanner, and Gitleaks: zero findings | | | In progress |
